<h3>
    ...
    <span id="from-per-amount">{{ number_format((float)$wallet_rate, 2, '.', '') }}</span>/
    <span class="from-coin-name">{{check_default_coin_type($from_wallet->coin_type)}}</span>
</h3>
<div class="swipe-in-top">
    <div class="swipe-count">
        <input type="text" id="from-amount" value="{{ number_format((float)$amount, 2, '.', '') }}" placeholder="0.00">
    ...
    <h5>
        ...
        <span class="" id="to-amount">{{ number_format((float)$convert_rate, 2, '.', '') }}</span>
