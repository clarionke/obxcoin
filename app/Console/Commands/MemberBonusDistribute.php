...
class MemberBonusDistribute extends Command
{
    ...
    {
        storeDetailsException('MemberBonusDistribute','Member bonus cron job called');
        $clubRepository->clubBonusDistributionProcess();
        storeDetailsException('MemberBonusDistribute','Member bonus cron job run successful');
    }
}
