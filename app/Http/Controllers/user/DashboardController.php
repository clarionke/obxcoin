...
class DashboardController extends Controller
{
    public function userDashboard(Request $request)
    {
        ...
        $data['co_wallet_feature_active'] = co_wallet_feature_active();
        $data['msig_wallet_count'] = 0;
        $data['msig_pending_approvals_count'] = 0;
        $data['msig_approval_percentage'] = (int) (settings(CO_WALLET_WITHDRAWAL_USER_APPROVAL_PERCENTAGE_SLUG) ?: 60);
        $data['msig_pending_approvals'] = collect();
